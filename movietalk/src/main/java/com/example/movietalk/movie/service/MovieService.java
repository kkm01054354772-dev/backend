...
public class MovieService {
    ...
    public Long updateRow(MovieDTO dto) {
        ...
        // movieRepository.save(movie); // dirty-checking
    ...
    public PageResultDTO<MovieDTO> getMovieList(PageRequestDTO pageRequestDTO) {
        ...
        // [Movie(mno=100, title=Movie Title 100), MovieImage(inum=311,
        // uuid=5afb6811-2098-44a4-aeb0-78958a975614, path=null, imgName=test0.jpg,
        // ord=0), 1, 4.0]
        ...
        // 방법 2.
        Function<? super Object[], MovieDTO> function = (obj -> entityToDTO((Movie) obj[0],
                List.of((MovieImage) obj[1]), (Long) obj[2], (Double) obj[3]));
