...
public class MemoController {
    ...
    @ResponseBody // 리턴값은 데이터라는 의미
    @GetMapping("/hello")
    public String getHello() {
        return "Hello World"; // 문자열은 부라우저 해석 가능
    }
    ...
    public void getList(Model model) {
        log.info("전체 메모 요청");
        List<MemoDTO> list = memoService.readAll(); // Controller <=> Service
        model.addAttribute("list", list); // thymeleaf
    }
