...
public class NovelController {
    ...
    @Operation(summary = "novel 상세 조회", description = "novel 상세 조회 API")
    @GetMapping("/{id}")
    ...
    // /api/novels/available/1 + PUT : available 수정
    ...
    @Operation(summary = "novel 수정", description = "novel 수정 API - 이용 가능 여부, 장르 변경")
    @PreAuthorize("hasAnyRole('ROLE_MEMBER','ROLE_ADMIN')")
    @PutMapping("/edit/{id}")
