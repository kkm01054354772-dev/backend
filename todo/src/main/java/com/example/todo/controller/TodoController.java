...
public class TodoController {
    ...
    @PutMapping("/{id}")
    public Long putTodo(@Parameter(description = "수정할 todo id", example = "1", required = true) @PathVariable Long id,
    ...
    public ResponseEntity<String> deleteTodo(
            @Parameter(description = "삭제할 todo id", example = "1", required = true) @PathVariable Long id) {
        log.info("삭제 {}", id);
